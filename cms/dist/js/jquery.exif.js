...
function findEXIFinJPEG(oFile) {
    ...
    if (!oFile.getByteAt || oFile.getByteAt(0) != 0xFF || oFile.getByteAt(1) != 0xD8) {
...
$.fn.fileExif = function(callback) {
    ...
    //reader.readAsBinaryString(getFilePart(this[0].files[0])); //20200217 readAsBinaryString 非推奨 readAsBinaryStringへ変更
...
$.fileExif = function(file, callback) {
    ...
    //reader.readAsBinaryString(getFilePart(file)); //20200217 readAsBinaryString 非推奨 readAsBinaryStringへ変更
