        ...
        <section class="col-lg-5">
          ...
          <div class="card">
            <div class="card-header">
              <div class="card-title">お届け希望日／送料設定</div>
            </div>
            <div class="card-body">
              <div class="form-row">

                <fieldset class="col-lg-6 yamato_order_number form-group">
                  <label class="small">
                    送り状番号
                    <span class="badge badge-warning">注意</span>
                  </label>
                  <input class="form-control" name="yamato_order_number" type="text" value="{$data->yamato_order_number|default}">
                </fieldset>

                <fieldset class="col-lg-6 expected_shipping_date form-group">
                  <label class="small">
                    出荷予定日
                    <span class="badge badge-danger">必須</span>
                    <span class="badge badge-warning">注意</span>
                  </label>
                  <input class="form-control  form-control-border" name="expected_shipping_date" type="date" value="{$data->expected_shipping_date}">
                </fieldset>

                <fieldset class="col-lg-6 form-group delivery_date">
                  <label class="small">ご希望のお届け日</label>
                  <input type="date" name="delivery_date" class="form-control  form-control-border" placeholder="ご希望のお届け日" value="{$data->delivery_date}">
                  <small class="form-text text-muted"></small>
                </fieldset>

                <fieldset class="col-lg-6 form-group delivery_time">
                  <label class="small">ご希望のお届け時間</label>
                  <select name="delivery_time" class="form-control  form-control-border">
                    {foreach $delivery_time_zone_value as $zone}{if $zone->time_zone}
                    <option value="{$zone->time_kbn}" data-code="{$zone->code}" {if $data->delivery_time == $zone->time_kbn}selected{/if}>{$zone->time_zone}</option>
                    {/if}{/foreach}
                  </select>
                  <small class="form-text text-muted"></small>
                </fieldset>

                <fieldset class="col-lg-6 delivery_price form-group">
                ...
                <fieldset class="col-6 col-lg-3 delivery_tax_class form-group">
                ...
                <fieldset class="col-6 col-lg-3 delivery_tax_rate form-group">
                ...
                <fieldset class="col-4 delivery_tax_price form-group">
                  <label class="small">税込&nbsp;<span class="badge badge-warning">自動</span></label>
                ...
                <fieldset class="col-4 delivery_notax_price form-group">
                  <label class="small">税抜き&nbsp;<span class="badge badge-warning">自動</span></label>
                ...
                <fieldset class="col-4 delivery_tax form-group">
                ...
                <fieldset class="col-lg-12 remarks form-group">
                  <label class="small">お問合せ</label>
                  <textarea class="form-control " id="remarks" name="remarks" rows="10" placeholder="お問合せ">{$data->remarks}</textarea>
                </fieldset>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-row">
                ...
                <fieldset class="col-lg-4 first_name form-group">
                ...
                <fieldset class="col-lg-4 last_name form-group">
                ...
                <fieldset class="col-lg-4 honorific_title form-group">
                  <label class="small">
                    敬称
                ...
                <fieldset class="col-lg-6 first_name_kana form-group">
                ...
                <fieldset class="col-lg-6 last_name_kana form-group">
                ...
                <fieldset class="col-lg-3 postal_code form-group">
                  <label class="small">
                    郵便番号
                ...
                <fieldset class="col-lg-3 prefecture_id form-group">
                ...
                <fieldset class="col-lg-6 municipality form-group">
                  <label class="small">
                    市区町村
                    <span class="badge badge-warning">検索可</span>
                  </label>
                ...
                <fieldset class="col-lg-4 address1 form-group">
                ...
                <fieldset class="col-lg-8 address2 form-group">
