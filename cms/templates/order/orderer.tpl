            ...
            <div class="card">
              ...
              <div class="card-body form-row">
                ...
                <fieldset class="settlement_id col-lg-12 form-group">
                  <label class="small">
                    決済方法を選択してください&nbsp;<span class="badge badge-danger">必須</span>
                  </label>
                  ...
                  <small class="form-text text-danger">
                    ※決済手数料は手動で変更してください。<br>
                    ※クレジット等、決済手続きが必要な場合も手動で行ってください。
                  </small>
                </fieldset>
                
                <fieldset class="settlement_date col-lg-12 form-group">
                  <label class="small">決済日</label>
                  <input type="date" name="settlement_date" class="form-control form-control-border" value="{$data->settlement_date}">
                </fieldset>
                ...
                <fieldset class="col-lg-12 corporation_kbn form-group">
                  ...
                  <div class="form-check form-check-inline">
                    <label for="corp{$kbn}" class="form-check-label">
                      <input id="corp{$kbn}" type="radio" class="form-check-input" name="corporation_kbn" value="{$kbn}" {if $data->corporation_kbn|default != null && $data->corporation_kbn == $kbn}checked{/if}>
                      {$value->name}
                    </label>
                  </div>
                  {/foreach}
