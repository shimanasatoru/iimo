        ...
        <section id="content" class="col-12">
          ...
          <div class="card">
            <div class="card-header row align-items-center">
              <div class="col">
                <a class="btn btn-sm btn-primary" href="{$smarty.const.ADDRESS_CMS}notification/edit/?{$smarty.server.QUERY_STRING}">
...
<script>
  ...
  $(document).on('sortstop', '#data', function(){
    ...
    var e = {
      params: {
        type: 'POST',
        url: ADDRESS_CMS + 'notification/push/sort/?dataType=json',
        data: form,
        dataType: 'json',
        processData: false,
        contentType: false
  ...
  function getData(){
    var e = {
      params: {
        type: 'GET',
        url: ADDRESS_CMS + 'notification/get/?dataType=json',
        data: null,
        dataType: 'json'
      },
      doneName: display
  ...
  function display(d){
    ...
    for(var i in row){
      var icon = null;
      var classes = null;
      var href = ADDRESS_CMS + 'notification/edit/'+ row[i].id +'/?{$smarty.server.QUERY_STRING}';
