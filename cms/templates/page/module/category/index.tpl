    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm">
          ...
          <p class="blockquote-footer mb-0">モジュールカテゴリを設定します。設定後はモジュールへ適用してください。</p>
        </div>
        <div class="col-sm-auto">
          <a class="btn btn-sm btn-outline-secondary rounded-pill" data-toggle="dropdown" href="#" aria-expanded="false">
            <i class="fas fa-cog"></i>
          </a>
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
            <a href="{$smarty.const.ADDRESS_CMS}pageModule" class="dropdown-item">
              <i class="fas fa-pager fa-fw mr-2"></i>
              モジュール
            </a>
            <div class="dropdown-divider"></div>
            <a href="{$smarty.const.ADDRESS_CMS}pageModuleCategory" class="dropdown-item">
        ...
        <section id="content" class="col-12">
          ...
          <div class="card">
            <div class="card-header row align-items-center">
              <div class="col">
                <button type="button" class="modal-url btn btn-sm btn-primary" data-id="modal-1" data-title="新規登録" data-footer_class="mf-edit-productCategory" data-url="{$smarty.const.ADDRESS_CMS}pageModuleCategory/edit/ #content">
