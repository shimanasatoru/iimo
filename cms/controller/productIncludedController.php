...
class productIncludedController{
  ...
  public function getAction(){
    ...
    $p = new productIncludedRepository;
    if($params['id']){
      $p->setId($params['id']);
    }
  ...
  public function indexAction(){
    ...
    $tpl->display("product/included/index.tpl");
  }
  ...
  public function editAction(){
    ...
    $s = new productIncludedRepository;
    $data = array();
    if($id){
      $s->setSiteId($_SESSION['site']->id);
      $s->setId($id);
      $s->setLimit(1);
      $data = $s->get()->row[0];
    }
    ...
    $tpl->display("product/included/edit.tpl");
  }
  ...
  public function pushAction(){
    ...
    $n = new productIncludedRepository;
